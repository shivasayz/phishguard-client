      ...
      <header className="bg-white/90 backdrop-blur-md border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/')}>
            ...
            <span className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-blue-700 bg-clip-text text-transparent">SecureInbox</span>
          </div>
          <button
            onClick={() => navigate('/')}
      ...
      <footer className="w-full bg-gray-900 text-white py-8 px-6 mt-12">
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="text-xl font-bold">SecureInbox</span>
          </div>
          <p className="text-gray-400 mb-1">© {new Date().getFullYear()} SecureInbox. All rights reserved.</p>
